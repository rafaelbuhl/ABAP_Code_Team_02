CLASS zcl_02_09_cs_import_19 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_02_09_cs_import_19 IMPLEMENTATION.
...
*        CLEAR gt_export_sorted_wa.
    ...
    ENDLOOP.
*
*    "Schritt 2.3/3: Spalten: Medium, auf email, telephon und fax verteilen
...
*        CLEAR gt_export_sorted_final_wa.
    ...
    DELETE ADJACENT DUPLICATES FROM gt_export_sorted_final COMPARING street city postcode fax phone email.
...
*      DATA mein_zaehler_n TYPE n LENGTH 6 VALUE '000000'.
*      DATA mein_zaehler_i TYPE i VALUE 1.
*
*      mein_zaehler_i = mein_zaehler_n.
*
*      mein_zaehler_i += 1 .
*
*      mein_zaehler_n = mein_zaehler_i.
*
*      out->write( mein_zaehler_n ).

    LOOP AT gt_export_sorted_final INTO gt_export_sorted_final_wa.

*       ZCS09_CUSTOMERS_WA-customerid = man_customerid.
...
*   try.
*       INSERT ZCS09_CUSTOMERS FROM TABLE @gt_export_sorted_final.
*       IF sy-subrc = 0.
