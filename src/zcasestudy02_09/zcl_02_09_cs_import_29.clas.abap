CLASS zcl_02_09_cs_import_29 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_02_09_cs_import_29 IMPLEMENTATION.
...
*    " der erste Datensatz bleibt, alle anderen werden gelöscht
     " Aber was mit den Datenverlust. Hier die Inhalte der Felder Fax, Phone, Email von der duplikate?
   out->write( lt_splitted_mapped ).
