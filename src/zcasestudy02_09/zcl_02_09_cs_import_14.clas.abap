CLASS zcl_02_09_cs_import_14 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_02_09_cs_import_14 IMPLEMENTATION.
...
*    "Werkzeuge: neue Tabelle vom TYP ZCS09_CUSTOMERS und ein Arbeitsbereich
    DATA gt_export_sorted_final TYPE TABLE OF zcs09_customers.
    DATA gt_export_sorted_final_wa TYPE zcs09_customers.
...
*        CLEAR gt_export_sorted_final_wa.
        ...
        IF gt_export_sorted_wa-medium = '' OR gt_export_sorted_wa-medium = 'Q' OR gt_export_sorted_wa = 'D1Fu'.
             gt_export_sorted_final_wa-phone =  gt_export_sorted_wa-val1 && ' ' && gt_export_sorted_wa-val2.
        ELSEIF gt_export_sorted_wa-medium = 'Telefax'.
            gt_export_sorted_final_wa-fax = gt_export_sorted_wa-val1 && ' ' && gt_export_sorted_wa-val2.
        ELSE.
            gt_export_sorted_final_wa-email = gt_export_sorted_wa-val1.
        ENDIF.
