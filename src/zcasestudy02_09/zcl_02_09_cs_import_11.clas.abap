CLASS zcl_02_09_cs_import_11 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_02_09_cs_import_11 IMPLEMENTATION.
...
* Beschreibung: *
*****************
" Dieses Programm liest die Daten aus der Tabelle "ztl_02_09_cs", verarbeitet die und schreibt die Ergebnisdaten in einer internen sortierten Tabelle ohne Duplikate

*** Definition



    "Werkzeug A: eine interne Tabelle mit ein Arbeitsbereich fürs interne Importieren
    DATA gt_import TYPE TABLE OF char256.
    DATA gt_import_wa TYPE char256.

    "Werkzeug B: Struktur, Tabelle und ein Arbeitsbereich für die interne Datenverarbeitung
    ...
    " Werkzeug C: eine interne sortierte Tabelle und Arbeitsbereich um Duplikate zu entfernen und Daten fürs Schreiben in einer Datenbanktabelle vorzubereiten
...
*** Processing
    ...
    " Schritt 1/3: Daten Lesen. Daten aus der Datenbank Tabelle in einer internen Tabelle lesen
    SELECT
    FROM ztl_02_09_cs
    FIELDS import
