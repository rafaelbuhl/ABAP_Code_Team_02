CLASS zcl_02_09_cs_import_06 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_02_09_cs_import_06 IMPLEMENTATION.
...
*** Processing
    ...
    LOOP AT gt_import INTO wa_import.
        ...
        CLEAR wa_export.
        wa_export-import            = to_lower( wa_import-import ).
*        wa_export-client            = to_lower( wa_import-client ).
*        wa_export-uuid              = wa_import-uuid.
*        wa_export-last_changed_at   = wa_import-last_changed_at.
