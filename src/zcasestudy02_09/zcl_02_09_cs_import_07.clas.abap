CLASS zcl_02_09_cs_import_07 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_02_09_cs_import_07 IMPLEMENTATION.
...
*** Definition
    ...
    "Werkzeug A: eine Tabelle mit zwei ein Arbeitsbereich
    DATA gt_import TYPE TABLE OF char256.
    DATA gt_import_wa TYPE char256.

    "Werkzeug B: Struktur für Datenexport der Tabelle und Arbeitsbereich
...
*** Processing
    ...
    " Schritt 2/3: Datenverarbeitung. Daten verteilen, bereinigen und sie in einer export Tabelle schreiben
...
*
*    identische Zeilennamen und Zeilentypen
*
*    -> wie kann man zwischen char255 und string hinundher kopieren
