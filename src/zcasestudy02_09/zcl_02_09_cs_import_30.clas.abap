CLASS zcl_02_09_cs_import_30 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_02_09_cs_import_30 IMPLEMENTATION.
...
*     out->write( '------------------Bis diese Stelle ist der Code korrekt, Anzahl der Datensätze ist richtig------------------' ).
   ...
   out->write( 'Wunderbar! Duplikate entfernt. Applikation kann angelegt werden.' ).
