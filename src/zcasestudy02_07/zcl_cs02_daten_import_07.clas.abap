CLASS zcl_cs02_daten_import_07 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    TYPES:
      BEGIN OF zt07_import_split,
        ...
        val1     TYPE string,
        val2     TYPE string,
      END OF zt07_import_split.

*    DATA:
*        badi_handler TYPE REF TO zcs02_07_import.
...
CLASS zcl_cs02_daten_import_07 IMPLEMENTATION.
