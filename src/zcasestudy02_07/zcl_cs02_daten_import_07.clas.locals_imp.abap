...
*      lc_nr_from   TYPE cl_numberrange_intervals=>nr_nriv_line-fromnumber VALUE '900000',
*      lc_nr_to     TYPE cl_numberrange_intervals=>nr_nriv_line-tonumber VALUE '999999'.
*    CLASS-DATA:
